...
//          ( field[i][j]() != field[(i + 2) % 3 + i - (i % 3)][(j + 2) % 3 + j - (j % 3)]() );
			{
				...
				c_regions ( field[i][j]() != field[(i + 2) % 3 + i - (i % 3)][ j                       ]() );

				c_regions ( field[i][j]() != field[ i                       ][(j + 1) % 3 + j - (j % 3)]() );
				c_regions ( field[i][j]() != field[(i + 1) % 3 + i - (i % 3)][(j + 1) % 3 + j - (j % 3)]() );
				c_regions ( field[i][j]() != field[(i + 2) % 3 + i - (i % 3)][(j + 1) % 3 + j - (j % 3)]() );

				c_regions ( field[i][j]() != field[ i                       ][(j + 2) % 3 + j - (j % 3)]() );
				c_regions ( field[i][j]() != field[(i + 1) % 3 + i - (i % 3)][(j + 2) % 3 + j - (j % 3)]() );
				c_regions ( field[i][j]() != field[(i + 2) % 3 + i - (i % 3)][(j + 2) % 3 + j - (j % 3)]() );
			}
	}
